...
add_action( 'current_screen', 'boros_add_dashboard_inc' );
function boros_add_dashboard_inc( $current_screen ){
...
/**
 * TESTS: Boros_Admin_Pages
 * 
 */
add_action( 'init', 'boros_admin_pages_init' );
function boros_admin_pages_init(){
